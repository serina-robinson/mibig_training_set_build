...
# saveRDS(rf, "data/model_comparisons/rf_xvalidated_small_subst_grp_20192604.rds")
rf <- readRDS("data/model_comparisons/rf_xvalidated_tuned_no_max_depth_20190904.rds")
...
rf_ml <- readRDS("data/model_comparisons/rf_xvalidated_tuned_no_max_depth_20190904.rds")
rf_ml$results[which.max(rf_ml$results$Accuracy),]
...
readRDS("data/model_comparisons/nnet_small_subst_group_20190204.rds")
nnet_ml$results[which.max(nnet_ml$results$Accuracy),]
# size decay
#  10 0.5
