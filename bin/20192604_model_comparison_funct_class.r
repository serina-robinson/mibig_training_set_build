...
# saveRDS(nb, "data/model_comparisons/nb_funct_class_20192604.rds")
nb_ml <- readRDS("data/model_comparisons/nb_funct_class_20192604.rds")
...
rf_ml <- ranger(y_train ~., data = form_train, num.trees = 500, splitrule = as.character(rf$bestTune$splitrule), 
                ...
                importance = "permutation")
saveRDS(rf_ml, "data/model_comparisons/rf_funct_class_20192604.rds")
rf_ml <- readRDS("data/model_comparisons/rf_funct_class_20192604.rds")
...
pdf("data/model_comparisons/rf_feat_select_var_imp_funct_class_20192604.pdf", width = 6, height = 6)
ggplot(data = vimp, 
...
#                          .size = c(3, 5, 10, 20))
nnet_grid <- expand.grid(.decay = c(0.5, 0.1, 1e-3,  1e-5, 1e-7),
                                                .size = c(5, 10, 20))
...
saveRDS(nnet_mod, "data/model_comparisons/nnet_funct_class_20192604.rds")
nnet_ml <- readRDS("data/model_comparisons/nnet_funct_class_20192604.rds")
nnet_ml$bestTune
nnet_ml$call
# size decay
#  10 0.5
...
pdf("data/model_comparisons/svm_radial_feat_select_var_imp_funct_class_20192604.pdf", width = 6, height = 6)
ggplot(data = vimp, 
       aes(x=reorder(variable,importance), y=importance, fill=importance))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Variable Importance")+
...
pdf("data/model_comparisons/svm_linear_feat_select_var_imp_funct_class_20192604.pdf", width = 6, height = 6)
ggplot(data = vimp, 
       aes(x=reorder(variable,importance), y=importance, fill=importance))+ 
  geom_bar(stat="identity", position="dodge")+ coord_flip()+
  ylab("Variable Importance")+
