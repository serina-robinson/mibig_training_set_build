...
# Read in the data
rawdat <- read_csv("data/793_seqs_136_feats_for_supervised_20190329.csv")
...
rf_ml <- ranger(y_train ~., data = form_train, num.trees = 500, splitrule = as.character(rf$bestTune$splitrule), 
                ...
                importance = "permutation")
saveRDS(rf_ml, "output/rf_small_subst_grp_20192903.rds")
rf_ml <- readRDS("output/rf_small_subst_grp_20192903.rds")
