# Install packages
pacman::p_load("caret", "Biostrings", "phangorn", "DECIPHER", 
                "tidymodels", "ranger", 
               "tree", "rsample", "tidyverse", "tidyverse")
...
sd(unlist(xx))  # 0.0304 standard deviation

ind <- which.max(unlist(xx)) # ind = 8, accuracy 88%
